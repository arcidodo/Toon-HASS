...
App {
    ...
    property url tileUrl2 : "HomeassistantPlusTile.qml";
    ...
    function init() {
        ...
        registry.registerWidget("tile", tileUrl2, this, null, {thumbLabel: qsTr("homeAssistantPlus"), thumbIcon: thumbnailIcon, thumbCategory: "general", thumbWeight: 30, baseTileWeight: 10, baseTileSolarWeight: 10, thumbIconVAlignment: "center"});
